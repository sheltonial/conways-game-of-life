...
describe("coordsToMatrix()", () => {
  it("empty coords", () => {
    ...
    expect(gol.coordsToMatrix(coords, 0, 0, 2, 2, "x")).toEqual(expected);
  });

  it("coords within offset matrix bounds", () => {
    const coords = [
      [-1, -1],
      [0, 0],
      [1, 1]
    ...
    expect(gol.coordsToMatrix(coords, -1, -1, 3, 3, "x")).toEqual(expected);
  });
  ...
  it("coords outside matrix bounds", () => {
    ...
    expect(gol.coordsToMatrix(coords, 0, 0, 3, 3, "x")).toEqual(expected);
  });
});

describe("filterCoordsInViewport()", () => {
  it("empty coords", () => {
    const coords = [];
    const expected = [];
    expect(gol.filterCoordsInViewport(coords, 0, 0, 2, 2,)).toEqual(expected);
  });
  ...
  it("coords within matrix bounds", () => {
    ...
    expect(gol.filterCoordsInViewport(coords, 0, 0, 3, 3)).toEqual(expected);
  });
  ...
  it("coords within offset matrix bounds", () => {
    ...
    expect(gol.filterCoordsInViewport(coords, -1, -1, 3, 3)).toEqual(expected);
  });
  ...
  it("coords outside matrix bounds", () => {
    ...
    const expected = [];
    expect(gol.filterCoordsInViewport(coords, 0, 0, 3, 3, "x")).toEqual(expected);
  });
});